...
`)
  ...
  />
      ...
      <div className="hidden print:flex fixed bottom-4 right-6 items-center gap-2 text-[10px] text-gray-500 italic opacity-60 print:opacity-80 pointer-events-none">
